package com.ilearning.common.swagger.config;
...
@ConditionalOnProperty(prefix = "ilearning.swagger", value = "enable", matchIfMissing = true)
...
//                .apis(basePackage("cn.iocoder.yudao.module.infra")) // 可用于 swagger 无法展示时使用
                ...
                .build()
//                .securitySchemes(securitySchemes()) // 鉴权请求头暂时不用
//                .globalRequestParameters(globalRequestParameters()) // 租户请求头暂时不用
