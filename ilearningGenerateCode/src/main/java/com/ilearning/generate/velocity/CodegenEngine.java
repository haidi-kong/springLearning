...
import com.ilearning.common.annotations.DictFormat;
import com.ilearning.common.annotations.OperateLog;
import com.ilearning.common.enums.OperateTypeEnum;
import com.ilearning.common.exception.ErrorCode;
import com.ilearning.common.exception.util.ServiceExceptionUtil;
...
import com.ilearning.common.util.DateUtils;
import com.ilearning.common.util.collection.CollectionUtils;
import com.ilearning.common.util.excel.DictConvert;
...
import com.ilearning.generate.enums.codegen.CodegenSceneEnum;
...
//                    javaModuleImplTestFilePath("service/${table.businessName}/${table.className}ServiceImplTest"))
            ...
            .put(javaTemplatePath("serverApplication"), javaModuleApiMainFilePath("ServerApplication"))
            // Vue
...
//                    vueFilePath("api/${table.moduleName}/${classNameVar}.js"))
    ...
    private void initGlobalBindingMap() {
        // 全局配置
        globalBindingMap.put("basePackage", CodegenProperties.getValue("gen.packageName"));
        globalBindingMap.put("baseFrameworkPackage", ""
        ...
        globalBindingMap.put("ErrorCodeClassName", ErrorCode.class.getName());
    ...
    private static String javaModuleFilePath(String path, String module, String src) {
        return CodegenProperties.getValue("gen.module") + // 顶级模块
...
//        return "ilearning-module-${table.moduleName}/" + // 顶级模块
//                "ilearning-module-${table.moduleName}-impl/" + // 子模块
//                "src/main/java/resources/mapper/${table.businessName}/${table.className}Mapper.xml";
    ...
    private static String vueFilePath(String path) {
        return "ilearning-ui-${sceneEnum.basePackage}/" + // 顶级目录
                "src/" + path;
    }
